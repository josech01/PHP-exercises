...
-- Volcando estructura de base de datos para ubigeo
CREATE DATABASE IF NOT EXISTS `ubigeo` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `ubigeo`;

-- Volcando estructura para tabla ubigeo.ubigeo
CREATE TABLE IF NOT EXISTS `ubigeo` (
  `dpto` varchar(3) NOT NULL,
  `prov` varchar(3) NOT NULL DEFAULT '0',
  `dist` varchar(3) NOT NULL DEFAULT '0',
  `nombre` varchar(100) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Volcando datos para la tabla ubigeo.ubigeo: ~8 rows (aproximadamente)
/*!40000 ALTER TABLE `ubigeo` DISABLE KEYS */;
INSERT INTO `ubigeo` (`dpto`, `prov`, `dist`, `nombre`) VALUES
	('01', '00', '00', 'AMAZONAS'),
